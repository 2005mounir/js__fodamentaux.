...
h1.innerText='Bibliothèque numérique';
...
link.innerHTML='ajouter'
link.href="ajouter-livre.html"

divinput.appendChild(link)
...
input.addEventListener("input", function() {
  ...
  let books = JSON.parse(localStorage.getItem("bibliotheque")) || bibliotheque;
  ...
  if (filtered.length === 0) {
    ...
    msg.textContent = "Aucun livre trouvé.";
    msg.style.color = "#b91c1c";
    msg.style.fontWeight = "bold";
    boooks.appendChild(msg);
  } else {
    
    filtered.forEach(book => checkbook(book.code));
  }
